...
function createLaunchAgentTool(context: ToolContext): OrchestratorParentTool {
  return defineTool({
    ...
    label: "Launch agent",
    description:
      "Start Shell, Claude Code, Codex, Copilot, Grok, or a configured custom agent as a background Orchestrator task.",
    ...
    promptGuidelines: [
      ...
      'Use runtime: "codex", runtime: "claude-code", runtime: "copilot", or runtime: "grok" for AI work such as code review, implementation, research, repo inspection, or analysis.',
